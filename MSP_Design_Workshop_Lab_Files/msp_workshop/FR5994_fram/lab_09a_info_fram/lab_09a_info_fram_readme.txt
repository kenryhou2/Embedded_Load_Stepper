...
technology to store non-volatile information, while the 'FR6989, 'FR5994 & 'FR4133 
use FRAM technology.
...
There is no MPU "protection" setup for the 'FR5994/6989 FRAM devices in this exercise. Instead,
...
- Fill in the blanks
- ('FR5994 only) Modify setting in linker command file
...
// ----------------------------------------------------------------------------
// hello.c  (for lab_09a_info_fram project)  ('FR5994 Launchpad)
// ----------------------------------------------------------------------------
