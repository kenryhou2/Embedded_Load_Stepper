...
// __MSP430F5529, __MSP430FR4133, __MSP430F5529, __msp430fr5994_H__, and 
// __MSP432P401R__ are defined by each of the processors respective header 
// files (shipped with the MSP430 or MSP432 Code Generation Tools
//***********************************************************************
...
//    #define HFXT_DO_SETUP   1
    ...
    #define MCLK_PORT       GPIO_PORT_P5                                        // ACLK Output pin:  P5.7 or PJ.1
    #define MCLK_PIN        GPIO_PIN7, GPIO_TERNARY_MODULE_FUNCTION

    #define SMCLK_PORT      GPIO_PORT_P3                                        // ACLK Output pin:  P3.4, P5.6, or PJ.0
    #define SMCLK_PIN       GPIO_PIN4, GPIO_SECONDARY_MODULE_FUNCTION

    #define ACLK_PORT       GPIO_PORT_P2                                        // ACLK Output pin:  P2.0, PJ.2 or P5.5
    #define ACLK_PIN        GPIO_PIN0, GPIO_TERNARY_MODULE_FUNCTION             // None of these map to BoosterPack pins
...
//    #define HFXT_DO_SETUP   1
    ...
    // TA1.2 = P1.3; TA0.1 = P1.0; TA0.2 = P1.1
    #define TIMER_BASE      TIMER_A1_BASE
    #define TIMER_PORT      GPIO_PORT_P1
    #define TIMER_PIN       GPIO_PIN3, GPIO_PRIMARY_MODULE_FUNCTION
    #define TIMER_VECTOR0   TIMER1_A0_VECTOR
