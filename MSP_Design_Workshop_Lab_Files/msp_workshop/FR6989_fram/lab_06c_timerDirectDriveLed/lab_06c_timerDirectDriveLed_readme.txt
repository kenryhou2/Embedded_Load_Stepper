...
proper connection - here's an excerpt from the lab solution:
        ...
        // When running this lab exercise, you will need to pull the JP7 jumper and
        // use a jumper wire to connect signal from P1.3 (on boosterpack pinouts) to
        // JP7.2 (bottom pin) of LED1 jumper ... this lets the TA1.2 signal drive 
...
// ----------------------------------------------------------------------------
// main.c  (for lab_06c_timerDirectDriveLed project)  ('FR6989 Launchpad)
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
// myTimers.c  (for lab_06c_timerDirectDriveLed project) ('FR6989 Launchpad)
// ----------------------------------------------------------------------------
